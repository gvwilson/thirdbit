...
9.  **Learn how to run meetings and make decisions.**
    ...
    but you *must* know how to [run a meeting]({{site.github.url}}/2018/05/11/meetings.html)
    and [make decisions]({{site.github.url}}/2019/06/13/marthas-rules.html).

10. **Celebrate when you can, grieve when you need to.**
    [Burnout]({{site.github.url}}/2015/11/09/daddy-why-dont-you-ever-laugh.html)
