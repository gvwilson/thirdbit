...
2.  Most software engineering research has the same effect on programmers
    ...
    However,
    some of it is also
    [the gulf between researchers and practitioners]({{'/2012/12/06/two-solitudes-illustrated.html' | relative_url}}),
...
I've made the case for #3 [before]({{'/2014/10/02/a-better-software-engineering-course.html' | relative_url}}),
and if anything,
the case is stronger now than it was [then]({{'/2015/11/29/exaptation.html' | relative_url}}).
