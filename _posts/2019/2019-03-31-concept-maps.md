...
<figure class="center">
  <img src="{{'/files/2019/03/00-introduction.svg' | relative_url}}" width="90%" class="centered">
  <figcaption>Introduction</figcaption>
</figure>
<figure class="center">
  <img src="{{'/files/2019/03/01-personas.svg' | relative_url}}" width="90%" class="centered">
  <figcaption>Learner Personas</figcaption>
</figure>
<figure class="center">
  <img src="{{'/files/2019/03/02-mental-models.svg' | relative_url}}" width="90%" class="centered">
  <figcaption>Mental Models</figcaption>
</figure>
<figure class="center">
  <img src="{{'/files/2019/03/03-assessment.svg' | relative_url}}" width="90%" class="centered">
  <figcaption>Formative Assessment</figcaption>
</figure>
<figure class="center">
  <img src="{{'/files/2019/03/04-cognitive-load.svg' | relative_url}}" width="90%" class="centered">
  <figcaption>Cognitive Load</figcaption>
</figure>
<figure class="center">
  <img src="{{'/files/2019/03/05-capacity.svg' | relative_url}}" width="90%" class="centered">
  <figcaption>Seven Plus or Minus Two</figcaption>
</figure>
<figure class="center">
  <img src="{{'/files/2019/03/06-learning.svg' | relative_url}}" width="90%" class="centered">
  <figcaption>Learning Strategies</figcaption>
</figure>
<figure class="center">
  <img src="{{'/files/2019/03/07-motivation.svg' | relative_url}}" width="90%" class="centered">
  <figcaption>Motivation and Demotivation</figcaption>
</figure>
<figure class="center">
  <img src="{{'/files/2019/03/08-performance.svg' | relative_url}}" width="90%" class="centered">
