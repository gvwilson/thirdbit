...
<p>
  ...
  <a href="{{'/pages/not-on-the-shelves-1997.html' | relative_url}}">1997</a>,
  <a href="{{'/pages/not-on-the-shelves-2003.html' | relative_url}}">2003</a>,
  <a href="{{'/pages/not-on-the-shelves-2009.html' | relative_url}}">2009</a>,
  and <a href="{{'/pages/not-on-the-shelves-2014.html' | relative_url}}">2014</a>
  led to
...
<ol>
  <li>
    <p>
      ...
      as <a href="{{'/2014/10/02/a-better-software-engineering-course.html' | relative_url}}">I outlined last year</a>,
...
<ol>
  ...
  <li>
    <p>
      <a href="{{'/2013/05/01/merging-is-the-real-revolution.html' | relative_url}}"><em>Diff and merge for spreadsheets</em></a>.
      Right now,
...
<p>
  ...
  <a href="{{'/2014/10/27/shuttleworth.html' | relative_url}}">the one I proposed to the Shuttleworth Foundation last year</a>:
