...
<div class="figure">
<img src="{{'/files/2013/06/bootcamps.png' | relative_url}}" alt="Cumulative Number of Bootcamps" /><p class="caption">Cumulative Number of Bootcamps</p>
</div>
<div class="figure">
<img src="{{'/files/2013/06/enrolment.png' | relative_url}}" alt="Cumulative Enrolment" /><p class="caption">Cumulative Enrolment</p>
</div>
