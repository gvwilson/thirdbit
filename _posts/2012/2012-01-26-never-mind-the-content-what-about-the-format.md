...
<p>As for <a href="#animate">animation</a>, I think we're stuck with video for now: prototyping an HTML5/SVG/Javascript animation framework for use in a learning tool would be a great research project, but we really do need to build a couple to throw away to find out if it's workable. If you'd lke to tackle it, please <a href="mailto:{{site.author.email}}">let us know</a>–I'd be happy to be your alpha tester.</p>
