...
> Please see [this post]({{'/2018/12/17/thirteen-percent/' | relative_url}})
> and [this one]({{'/2018/12/19/fourteen-percent/' | relative_url}}) for follow-on thoughts.
...
and [wondering why they don't do it more often]({{'/2016/04/29/why-teachers-dont-collaborate/' | relative_url}}).
...
about [what hasn't worked in the past]({{'/2018/12/02/oer-landmines/' | relative_url}}),
though,
...
2. Version control:
   ...
   [version control is too high a cover charge for most people]({{'/2018/12/02/oer-landmines/' | relative_url}}):
