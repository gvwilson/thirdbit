...
[*JavaScript versus Data Science*]({{'/js4ds/' | relative_url}}) online for free,
...
and to think some more about [accessible lesson templates]({{'/2018/12/12/twelve-percent/' | relative_url}}).
...
[we'd like to hear from you](mailto:{{site.author.email}}).
