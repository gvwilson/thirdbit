...
- Incognito browsing doesn't store history,
  but doesn't make you invisible to your ISP
  - Or the coffee shop owner, or…
  - SMS messaging (texts) are basically in the clear
- A *virtual private network* (VPN) connects to a server
  then has that server connect to other sites on your behalf
...
- If someone from your bank asks you for information to confirm your identity,
  call them back using the number in the phone book
...
- Encrypting your hard drive helps is quick and easy
  - [BitLocker](https://learn.microsoft.com/en-us/windows/security/operating-system-security/data-protection/bitlocker/) on Windows,
    [FileVault](https://support.apple.com/en-ca/guide/deployment/dep82064ec40/web) on MacOS
- Use secure deletion tools like [BleachBit](https://www.bleachbit.org)
  or [FileShredder](https://www.fileshredder.org) before discarding any hardware
...
- But the EU now has a [right to be forgotten](https://gdpr.eu/right-to-be-forgotten/),
