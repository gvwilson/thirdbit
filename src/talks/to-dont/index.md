...
-   A to-<em>don't</em> list is just as useful

    -   Because life is short and you're busy

-   But other people may be looking for ideas

-   And explaining *why* I want these may help you understand
    what practitioners actually want from researchers
...
-   Are some languages actually better than others?

-   [Stefik2013](https://doi.org/10.1145/2534973) measured how well novices could recognize
    Perl, Quorum, and Randomo
...
-   [Fucci2016](https://doi.org/10.1145/2961111.2962592)
    studied 39 professionals working on real projects over an extended period

-   No significant difference between test-first and test-last development

-   But "The claimed benefits of TDD may…rather [be] due to the fact that
    [it] encourages fine-grained steady steps that improve focus and flow."

    -   Are we giving credit for improvement to the wrong cause?

--

> I practice TDD…and it works great. We don't need to prove that it works anymore.
>
> — posted by someone who sells TDD training

---

## Do 10X Programmers Exist?

-   [Prechelt2000](https://doi.org/10.1109/2.876288)
    had programmers implement the same thing independently

-   How long did it take?

<div class="center">
  <img src="@root/files/talks/productivity.svg">
</div>
...
-   Shortest and longest times were 0.6 and 63 hours (150X)
...
-   Which is consistent with productivity variation in other white collar professions

---

## So Why *Is* This Cool?

-   Intellectual curiosity: how does this stuff actually work?

-   Self-interest: get more done in less time and with less pain

-   Being less wrong: a lot of well-paid people repeat Silicon Valley BS to each other

    -   Which becomes quite irritating when you know better

--

-   But mostly because *it gets practitioners' attention*

    -   The projects I cited in "Who Am I?" were a great way to make new friends
...
-   But almost all of us believe version control makes us more productive
...
-   Computational notebooks are ubiquitous
    ...
    -   [Quarto](https://quarto.org/) is Markdown with embedded code

    -   See [Crichton2024](http://dx.doi.org/10.1145/3632865) for a taxonomy
...
-   Is there a Unified Theory of Diff similar to
    [Mokhov2020](http://dx.doi.org/10.1017/s0956796820000088)?
...
-   Note: [Denny2019](https://dl.acm.org/doi/10.1145/3291279.3339402) found no overlap
    between the things CS education researchers study
    and the things CS educators want to know
...
-   Analyze
    ...
    to see what claims they make

-   Then survey programmers to see which (if any) they believe

-   And check that against the literature to see which are currently considered true
...
-   Survey these courses to determine what they *don't* teach
    ...
    -   How many devote time to employees' rights?

    -   How many discuss anti-trust legislation?

    -   How many talk about business models other than venture capital and explosive growth?
...
-   But that's [another talk](@root/talks/sdgc/)

---

## My Real Purpose

-   My generation kind of messed up

-   We desperately need more science and more courage

-   Learn with simple problems like developer productivity

    -   Practice with harder ones like ethics in software development
...
but that you're not actually going to start because life is short
and you're too busy for yet another side project.
