...
<ol>
  ...
  <li>Volunteers to lead "sales" conversation with not-yet-scheduled bootcamps
    <ul>
      <li>Go to the SWC GitHub repo and volunteer to help coordinate workshop</li>
    </ul>
  </li>
  ...
  <li>Volunteers for minor tasks
    <ul>
      <li>Someone to volunteer to write numpy/matplotlib [Joon Ro just developed some material as well] [I thought Matt had a start on this?]</li>
    </ul>
  </li>
