...
*(This article originally appeared in <u>Doctor Dobb's Journal</u>.)*

When I first started doing book reviews for *Doctor Dobb's Journal*
in 1997, I wrote an article called "Not on the Shelves".
...
groupware tool which is the running example in *Multi-Tier
Architectures: Theory and Practice* (reviewed below). Students
...
(JVM). Like Kamin's *Programming Languages: An Interpreter-Based
Approach*, this book builds up its JVM in stages.  Each stage
...
The running example in the book's second half is Stanley, a simple
...
these tools are built.  (Students who have used *Introduction to
Software Development* in an earlier course will already be
...
using *Introduction to Computer Architecture and Systems
Programming*).
...
Take Dustin's recent *Effective Software Testing* as an
...
In contrast, *Quality Assurance: Theory and Practice*
...
In the second part of the book, Chapter 5 looks at integrating testing
...
When Andrew Tanenbaum's *Operating Systems: Design and
Implementation* appeared in the mid-1980s, a typical PC had an
...
*Computing and the Law* presents this problem, and several
...
This book covers much of the same ground as *Introduction to
Software Development* (reviewed earlier), but with less depth and
