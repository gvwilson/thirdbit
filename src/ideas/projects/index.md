...
### Blocks-Based Data Science {: #blocks-based-data-science}
...
### Developer Discussion Tools {: #discussion-tools}
...
### Distributed Systems Simulators {: #distributed-systems}
...
### Lesson Syndication {: #lesson-syndication}
...
### A Little WYSIWYG Editor {: #little-wysiwyg}
...
### Markdown to DOM {: #markdown-to-dom}
...
### Software Team Simulator {: #software-team-simulator}
...
### WYSIWYG Computational Notebook {: #wysiwyg-notebook}
...
### Tower Support Game {: #tower-support}
...
### Calibrated Code Review {: #code-review}
...
### GenAI for Architecture Descriptions {: #genai-architecture}
...
### Validity of Software Engineering Claims {: #se-claims}
...
### Software Performance by Example {: #performance-example}
