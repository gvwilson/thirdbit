...
- Runnable application: a locally installable Python package containing at least four fully implemented scenarios with interactive parameter controls and live-updating charts
- Source code in a public Git repository under an open-source license (MIT preferred)
- Technical design document covering the scenario module interface, the concurrency strategy for live chart updates, and the GUI framework selection rationale
- User guide explaining how to install and run the application and how to interpret the output of each scenario
- Scenario extension guide documenting how to add a new scenario to the application
- Calibration report documenting the external review sessions, the feedback received, and the parameter adjustments made in response
- A 3-minute demo video showing all four scenarios running with different parameter settings and narrating what the outputs mean
