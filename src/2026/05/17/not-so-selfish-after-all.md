...
and debates about global climate governance.
...
1.  Members have clearly defined rights to the resource.
1.  Rules are adapted to local conditions rather than imposed from outside.
1.  People affected by the rules have meaningful input into changing them.
1.  A system exists for monitoring both the resource and the behavior of users.
1.  Sanctions are graduated—minor violations draw minor consequences.
1.  Conflicts can be resolved quickly and cheaply.
1.  External authorities recognize the community's right to self-organize.
1.  Larger systems are built from nested smaller ones.
